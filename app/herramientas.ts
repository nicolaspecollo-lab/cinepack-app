...
export const HERRAMIENTAS: Record<string, Record<string, CargoTools>> = {
  Ejecutivo: {
    ...
    "Legal": {
      ...
      cargo: [
        {
          id: "ej-derechos-pi", nombre: "Cadena de titularidad y derechos", tipo: "tabla",
          hint: "Registro por obra/elemento: quién es el titular original y todas las cesiones/licencias que salieron de ahí, por territorio, con exclusividad y vencimiento.",
          columnas: [
            ...
            { key: "cesiones", label: "Cesiones y licencias", tipo: "repetible", sub: [
              ...
              { key: "vigencia", label: "Vigencia desde", tipo: "fecha" as const },
              { key: "caducidad", label: "Caducidad", tipo: "fecha" as const },
              { key: "estado", label: "Estado", tipo: "estado", opciones: ["Pendiente", "Negociando", "Firmado", "Vencido"] },
            ]},
            { key: "documentos", label: "Documentos", tipo: "repetible", sub: [
              { key: "nombre", label: "Documento" },
              { key: "archivo", label: "Archivo", tipo: "archivo" as const },
        ...
        {
          id: "ej-cesion-nda", nombre: "Acuerdos de confidencialidad (NDA)", tipo: "tabla",
          hint: "Solo NDAs. Las cesiones de derechos ya se registran en Cadena de titularidad y derechos, no se duplican acá.",
          columnas: [
    ...
    "Financiación y Seguros": {
      ...
      cargo: [
        {
          id: "ej-polizas-permisos", nombre: "Pólizas de seguro", tipo: "tabla",
          hint: "Registro por póliza: aseguradora, cobertura y límites, más los certificados de asegurado adicional (COI) que exige cada locación o proveedor, con su propia vigencia. Los permisos de rodaje se gestionan en Producción, en 'Control de permisos de rodaje' — acá no se duplican.",
          columnas: [
            { key: "item", label: "Póliza" },
            { key: "aseguradora", label: "Aseguradora / Broker" },
            { key: "tipo", label: "Tipo de cobertura", tipo: "estado", opciones: ["Responsabilidad civil general", "Equipo y cámara", "Elenco (cast)", "Errores y omisiones", "Vehículos", "Responsabilidad civil patronal", "Otro"] },
            { key: "cobertura", label: "Alcance", tipo: "largo" },
            { key: "limite_cobertura", label: "Límite de cobertura", tipo: "money" as const },
            { key: "prima", label: "Prima", tipo: "money" as const },
            { key: "desde", label: "Vigencia desde", tipo: "fecha" as const },
            { key: "hasta", label: "Vigencia hasta", tipo: "fecha" as const },
            { key: "estado", label: "Estado", tipo: "estado", opciones: ["Gestionando", "Vigente", "Vencido"] },
            { key: "certificados", label: "Asegurados adicionales (COI)", tipo: "repetible", sub: [
              { key: "locacion_proveedor", label: "Locación / Proveedor" },
              { key: "vigencia_desde", label: "Vigencia desde", tipo: "fecha" as const },
              { key: "vigencia_hasta", label: "Vigencia hasta", tipo: "fecha" as const },
              { key: "estado", label: "Estado", tipo: "estado", opciones: ["Pendiente", "Emitido", "Vencido"] },
              { key: "archivo", label: "Certificado", tipo: "archivo" as const },
            ]},
            { key: "documentos", label: "Documentos", tipo: "repetible", sub: [
              { key: "nombre", label: "Documento" },
              { key: "archivo", label: "Archivo", tipo: "archivo" as const },
