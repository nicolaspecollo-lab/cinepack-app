...
<html>
  ...
  <body style="margin:0;padding:0;background:#0D0D12;" bgcolor="#0D0D12">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#0D0D12" style="background:#0D0D12;padding:48px 20px;">
      <tr>
        <td align="center" bgcolor="#0D0D12">
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" bgcolor="#16161D" style="max-width:480px;width:100%;background:#16161D;border:1px solid rgba(255,255,255,0.08);">
            <tr>
              <td align="center" bgcolor="#16161D" style="padding:34px 36px 26px 36px;text-align:center;background-color:#16161D;background-image:url('${HEXBG}');background-repeat:repeat;">
            ...
            <tr>
              <td align="center" bgcolor="#16161D" style="padding:28px 36px 0 36px;text-align:center;background-color:#16161D;font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:1.65;color:#c8cad4;">
            ...
            <tr>
              <td align="center" bgcolor="#16161D" style="padding:30px 36px 6px 36px;text-align:center;background-color:#16161D;">
            ...
            <tr>
              <td align="center" bgcolor="#16161D" style="padding:16px 36px 0 36px;text-align:center;background-color:#16161D;font-family:Helvetica,Arial,sans-serif;font-size:11px;color:#6f6f7a;">
                Al crear tu cuenta aceptas nuestra <a href="${APP_URL}/legal/privacidad" style="color:#8a8a95;">política de privacidad</a>.
              </td>
            </tr>
            <tr>
              <td bgcolor="#16161D" style="padding:22px 36px 0 36px;background-color:#16161D;">
                <div style="height:1px;background:rgba(255,255,255,0.08);"></div>
              </td>
            </tr>
            <tr>
              <td align="center" bgcolor="#16161D" style="padding:18px 36px 32px 36px;text-align:center;background-color:#16161D;font-family:Helvetica,Arial,sans-serif;font-size:11.5px;line-height:1.6;color:#6f6f7a;">
                Si el botón no funciona, copia este enlace en tu navegador:<br />
                <a href="${link}" style="color:#8a8a95;word-break:break-all;">${link}</a>
              </td>
            </tr>
          </table>
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" bgcolor="#0D0D12" style="max-width:480px;width:100%;background:#0D0D12;">
            <tr>
              <td bgcolor="#0D0D12" style="padding:20px 12px 0;text-align:center;background-color:#0D0D12;font-family:Helvetica,Arial,sans-serif;font-size:11px;color:#5a5a63;">
                CINE PACK — gestión de producción audiovisual · cinepack.es
              </td>
            </tr>
            <tr>
              <td bgcolor="#0D0D12" style="padding:14px 20px 0;text-align:justify;background-color:#0D0D12;font-family:Helvetica,Arial,sans-serif;font-size:9.5px;line-height:1.55;color:#4a4a52;">
